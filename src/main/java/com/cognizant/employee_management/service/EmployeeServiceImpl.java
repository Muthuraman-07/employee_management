...
public class EmployeeServiceImpl implements EmployeeService, UserDetailsService {
	...
	public EmployeeDto updateEmployee(int id, EmployeeDto employeeDto) {
		...
		try {
			...
			Shift shift = shiftRepository.findById(employeeDto.getShiftId()).orElseThrow(() -> {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		try {
			...
			return new org.springframework.security.core.userdetails.User(employee.getUsername(),
					employee.getPassword(), Collections.singletonList(new SimpleGrantedAuthority(employee.getRole())));
		} catch (Exception e) {
